                ...
                <div class="card-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            {{ Form::text('subject', null, ['class' => 'form-control font-style', 'required' => 'required', 'placeholder'=>__('Subject')]) }}
                        </div>
                        <div class="form-group col-md-6">
                            {{ Form::label('from', __('From'), ['class' => 'col-form-label text-dark']) }}<x-required></x-required>
                            {{ Form::text('from', $emailTemplate->from, ['class' => 'form-control font-style', 'required' => 'required', 'placeholder'=>__('From')]) }}
                        </div>
